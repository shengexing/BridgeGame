  ...
  <body>
  	...
  	<div id="inf" style="position: absolute; width: 1260px; height: 70px;">
	  	...
	  	<div class="inf" id="toolInf" style="position: absolute; left: 0px; bottom: 0px;">
	  		<a href="jsp/admin/mainBottom.jsp" target="bottom"><label style="font: italic; font-family: cursive; font-size: 25px; color: purple; background-color: threedshadow;">首页</label></a>
	  		<a href="logout"><img alt="注销" title="注销" src="./picture/logout.PNG" style="position: absolute; right: 10px; bottom: 2px;"></a>
	  	</div>
	 </div>
