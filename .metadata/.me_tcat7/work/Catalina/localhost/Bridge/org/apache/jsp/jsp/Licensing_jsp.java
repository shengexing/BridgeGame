 ...
 * Generated at: 2018-06-10 11:22:35 UTC
...
public final class Licensing_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String basePath = request.getScheme() + "://"
      ...
      out.write("\">\r\n");
      out.write("\r\n");
      out.write("<title>单人桥牌叫牌游戏</title>\r\n");
      out.write("\r\n");
      out.write("<link href=\"./css/Licensing.css\" type=\"text/css\" rel=\"stylesheet\"></link>\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("    \t\r\n");
      out.write("    \tvar current_player = 0;\t\t// 当前玩家的编号\r\n");
      out.write("    \tvar count_ending = 0;\t\t// 是否满足回合结束的条件\r\n");
      out.write("    \tvar current_contract = \"\";\t// 当前的定约结果\r\n");
      out.write("    \tvar current_banker = \"\";\t// 当前叫约定的玩家\r\n");
      out.write("    \tvar current_dbl = \"\";\t\t// 当前的加倍结果\r\n");
      out.write("    \t\r\n");
      out.write("    \t/* 取得指定id的对象*/\r\n");
      ...
      out.write("    \t\tgetObj(\"center_butStart\").style.display=\"none\";\r\n");
      out.write("    \t\tgetObj(\"center_licensing\").style.display=\"block\";\r\n");
      out.write("    \t\tgetObj(\"nameN\").innerHTML=\"玩家1\";\r\n");
      out.write("    \t\tgetObj(\"nameE\").innerHTML=\"玩家1\";\r\n");
      out.write("    \t\tgetObj(\"nameS\").innerHTML=\"玩家1\";\r\n");
      out.write("    \t\tgetObj(\"nameW\").innerHTML=\"玩家1\";\r\n");
      out.write("    \t\tgetObj(\"nameI\").innerHTML=\"玩家1\";\r\n");
      out.write("    \t}\r\n");
      out.write("    \t\r\n");
      out.write("    \t/* 复位程序：玩家再来一局*/\r\n");
      ...
      out.write("\t\t\t\t\tgetObj(\"infContractValue\").innerHTML = current_contract + current_dbl;\r\n");
      out.write("\t\t\t\t\tgetObj(\"infBankerValue\").innerHTML = current_banker == 0 ? \"北\" : current_banker == 1 ? \"东\" : current_banker == 2 ? \"南\" : \"西\";\r\n");
      out.write("\t\t\t\t\tsetButtonDisable(36);\r\n");
      out.write("\t\t\t\t\tgetObj(\"center_butAgain\").style.display=\"block\";\r\n");
      ...
      out.write("\t\t\tvar but_Dbl = getObj(\"button36\");\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif(butID == 35) {\t// 点击的叫牌卡是：Pass\r\n");
      out.write("\t\t\t\tbut_Dbl.value = \"Dbl\";\r\n");
      out.write("\t\t\t\tbut_Dbl.disabled = true;\r\n");
      out.write("\t\t\t\tvalue = \"--\";\r\n");
      out.write("\t\t\t\tcount_ending++; \r\n");
      out.write("\t\t\t} else if(butID == 36) {\t// 点击的叫牌卡是：Dbl/Rdbl\r\n");
      out.write("\t\t\t\tif(value == \"Dbl\") { value = \"x\"; current_dbl = \"x\"; e.target.value = \"Rdbl\";}\r\n");
      out.write("\t\t\t\tif(value == \"Rdbl\") { value = \"xx\"; current_dbl = \"xx\"; e.target.disabled = true;}\r\n");
      out.write("\t\t\t\tcount_ending = 0;\r\n");
      out.write("\t\t\t\t} else { \t// 点击1梅花~7NT叫牌卡\r\n");
      out.write("\t\t\t\t\tif(current_contract == \"\") getObj(\"button36\").style.display=\"block\";\r\n");
      out.write("\t\t\t\t\tbut_Dbl.value = \"Dbl\"; but_Dbl.disabled = false;\r\n");
      out.write("\t\t\t\t\tcurrent_contract = value; current_dbl = \"\"; count_ending = 0;\r\n");
      out.write("\t\t\t\t\tcurrent_banker = current_player % 4;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar row = Math.floor(current_player / 4);\r\n");
      out.write("\t\t\tvar col = current_player % 4;\r\n");
      out.write("\t\t\tvar id = \"DataTr\" + row + \"Td\" + col;\r\n");
      out.write("\t\t\tgetObj(id).innerHTML = value;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tgetObj(\"countdown\").innerHTML = 0;\r\n");
      out.write("\t\t\tif(butID < 35) setButtonDisable(butID);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 设置按钮不能被按*/\r\n");
      out.write("\t\tfunction setButtonDisable(val) {\r\n");
      out.write("\t\t\tfor(var i = val; i >= 0; i--) {\r\n");
      out.write("\t\t\t\tvar b = getObj(\"button\" + i);\t// 获取不能被按的按钮\r\n");
...
Poker.licensing(0); // 先给北发牌
      ...
      out.write("    \t\tgetObj(\"center_licensing\").style.display=\"none\";\r\n");
...
for (int i = 0; i < 13; i++) {
      ...
      out.write("\r\n");
      out.write("\t\t\t\tgetObj(\"img_cardsN");
      out.print(i);
      out.write("\").src=\"./picture/cards/north/");
      out.print(colorN);
      out.print(numberN);
      out.write(".JPG\";\r\n");
      out.write("\t\t\t\tgetObj(\"img_cardsI");
      out.print(i);
      ...
      out.write("\r\n");
      out.write("\t\t\tgetObj(\"positionI\").innerHTML=\"北\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 隐藏北家的牌*/\r\n");
...
for (int i = 0; i < 13; i++) {
      ...
      out.write("\r\n");
      out.write("\t\t\tgetObj(\"positionI\").innerHTML=\"东\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 隐藏东家的牌*/\r\n");
...
for (int i = 0; i < 13; i++) {
      ...
      out.write("\r\n");
      out.write("\t\t\tgetObj(\"positionI\").innerHTML=\"南\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 隐藏南家的牌*/\r\n");
...
for (int i = 0; i < 13; i++) {
      ...
      out.write("\r\n");
      out.write("\t\t\tgetObj(\"positionI\").innerHTML=\"西\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t/* 隐藏西家的牌*/\r\n");
...
for (int i = 0; i < 13; i++) {
      ...
      out.write("\t\t\t<input id=\"center_licensing\" type=\"button\" onclick=\"licensing();\" value=\"发牌\">\r\n");
      out.write("\t\t\t<input id=\"center_butAgain\" type=\"button\" onclick=\"reset();\" value=\"再来一局\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t<!-- 当前的牌手的信息 -->\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t<!-- 叫牌过程中需要显示的信息及按钮 -->\r\n");
      out.write("\t<div class=\"sop\" id=\"but\">\r\n");
      out.write("\t\t<!-- 显示叫牌过程中的关键信息 -->\r\n");
      out.write("\t\t<div class=\"inf_class\" id=\"inf_id\">\r\n");
      out.write("\t\t\t<div id=\"inf_licensing\">\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"inf_contract\">\r\n");
      out.write("\t\t\t\t<label id=\"infContractTitle\">定约结果：</label>\r\n");
      out.write("\t\t\t\t<label id=\"infContractValue\"></label>\r\n");
      out.write("\t\t\t\t<label id=\"infBankerTitle\">庄家：</label>\r\n");
      out.write("\t\t\t\t<label id=\"infBankerValue\"></label>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\r\n");
